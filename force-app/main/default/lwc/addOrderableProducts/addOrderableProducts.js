...
export default class AddOrderableProducts extends LightningElement {
    ...
    getSelectedName (event) {
        ...
        for (let i = 0; i < selectedRows.length; i++){
            ...
            this.selectedItems[selectedRows[i].Id] = { Id: selectedRows[i].Id, Name: selectedRows[i].Name, UnitPrice: selectedRows[i].UnitPrice };
        }
    }
    ...
    handleAddProducts () {
        ...
        // Add the selected products to the current order.
            ...
            this.dispatchEvent(new CustomEvent(EVENT_PRODUCTS_ADDED, { detail: productsSelected }));
        }
        this.selectedItems = {};
        this.handleDlgClose();
    }
    ...
    handleSearch () {
        ...
        getProducts ({searchKey: this.queryTerm, pricebookId: this.pricebookId, pageSize: parseInt(this.recordsPerPage) })
        .then (result => {
